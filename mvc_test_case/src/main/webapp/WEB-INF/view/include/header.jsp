...
<html>
  ...
  <body class="skin-blue sidebar-mini">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <small>Preview</small>
     		<style>
				.now_time {width:275px;margin:0 auto;margin-top:10px;padding:4px 0 6px 0;font-weight:bold;text-align:center;border:1px solid #aaa;background:#fcfcfc;}
				.inspection_time_wrp {position:relative;height:135px;background:url('//image.webzen.kr/n_portal/content/ins_loading_bg.gif') repeat-x left bottom;}
				.inspection_time_txt {position:absolute;left:0;top:90px;width:820px;text-align:center;font-weight:bold;color:#fff;}
				.inspection_loading {position:relative;float:left;padding-left:0;background:url('//image.webzen.kr/n_portal/content/ins_loading_line.gif') repeat-x;}
				.inspection_loading .icon_chr {position:absolute;right:0;top:0;width:51px;height:80px;margin-right:-20px;background:url('//image.webzen.kr/n_portal/content/ins_loading_chr.gif') no-repeat right top;}
				.inspection_loading .icon_bar {position:absolute;right:0;top:86px;width:100%;height:30px;background:url('//image.webzen.kr/n_portal/content/ins_loading_line.gif') no-repeat;}
				.inspection_loading .txt {position:absolute;right:0;top:28px;height:20px;text-align:center;margin-right:-17px;font-weight:bold;color:#d30000;}
				.inspection_wrp h2 {padding:45px 0 5px 0;font-size:13px;}
			</style>
			...
			<article class="inspection_time_wrp">
				<div class="inspection_loading" id="inspection_loading" style="width:35%;">
					<div class="icon_chr"></div>
					<div class="icon_bar"><div class="txt" id="progressBar">35%</div></div>
				</div>
			<div class="inspection_time_txt">점검시간 : 2018.10.18 08:30 ~2018-10-18 12:00</div>
			</article>
	</article>
          </h1>
          <ol class="breadcrumb">
    ...
    function Update() {
        ...
        var startTime = new Date("10/18/2018 8:30:00 AM").getTime();
        var endTime = new Date("10/18/2018 12:00:00 PM").getTime();
